...
class FTCApiService:
    """Simplified FTC API service with HTTP caching header support for Events"""
    ...
    def __init__(self, credentials: Dict[str, str]):
        ...
        self.headers = {
            ...
            "User-Agent": "FTC-Predictor-Events-Range-Sync/1.0",
        }
    ...
    async def get_events(
        ...
        while True:
            ...
            if page > 100:
                logger.warning("[FTC API] Reached page limit (100), stopping pagination")
                break
